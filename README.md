...
> **Статус на сентябрь 2026.** Проект переезжает на VPS, источник скидок меняется с Reddit на поиск магазина Steam. Часть функций из списка ниже в коде не реализована. Актуальное состояние, известные дефекты и план работ описаны в [docs/](docs/README.md).
